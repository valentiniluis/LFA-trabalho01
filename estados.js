...
const transicoes = {
    ...
    "bloqueando": { "A": estados.q2, "B": estados.q1, "R": estados.q7, "E": estados.q3 },
    "atacando": { "A": estados.q2, "B": estados.q1, "R": estados.q7 },
    "ataque especial": {},
    "atingido": { "A": estados.q2, "B": estados.q1, "R": estados.q7, "E": estados.q3 },
    "sem stamina": { "B": estados.q1, "R": estados.q7 },
    "recarregando energia": { "A": estados.q2, "B": estados.q1, "R": estados.q7, "E": estados.q3 },
    "venceu": {},
    "derrotado": {}
}
...
/*
 ...
 Recarregar stamina recupera 25 de energia/stamina para o jogador, mas o deixa vulnerável a ataques.

 O comando de bloquear não tem custo de energia para os jogadores.
*/
...
const transicao = (jogador1, jogador2, comandoJogador1, comandoJogador2) => {
    ...
    if (jogador1.estadoAtual == 'recarregando energia') {
        jogador1.stamina += 25;
